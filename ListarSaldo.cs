...
namespace ListarSaldo
{
    public partial class FrmSaldos : Form
    {
        ...
        private DataGridView saldosDataGridView;
        ...
        private void InitializeComponent()
        {
            ...
            // Configurações do grid de saldos
            saldosDataGridView = new DataGridView();
            saldosDataGridView.Location = new Point(20, 40);
            saldosDataGridView.Size = new Size(440, 280);
            saldosDataGridView.AllowUserToAddRows = false;
            saldosDataGridView.AllowUserToDeleteRows = false;
            saldosDataGridView.ReadOnly = true;
            saldosDataGridView.MultiSelect = false;
            saldosDataGridView.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            saldosDataGridView.AutoGenerateColumns = false;
            ...
            saldosDataGridView.Columns.Add(idColumn);
            ...
            saldosDataGridView.Columns.Add(nomeColumn);
            ...
            saldosDataGridView.Columns.Add(precoColumn);
            ...
            saldosDataGridView.Columns.Add(quantidadeColumn);

            this.Controls.Add(saldosDataGridView);
        }

        private void NovoButton_Click(object sender, EventArgs e)
        {
            FrmNovoSaldo saldo = new FrmNovoSaldo();
            saldo.Show();
